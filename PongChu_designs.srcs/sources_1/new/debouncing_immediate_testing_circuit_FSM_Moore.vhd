...
entity debouncing_immediate_testing_circuit_FSM_Moore is
...
end debouncing_immediate_testing_circuit_FSM_Moore;
...
architecture Behavioral of debouncing_immediate_testing_circuit_FSM_Moore is
...
-- ==========================
debouncing_circuit : debouncing_FSM_Moore_immediate
GENERIC MAP( LIMIT => LIMIT_debouncing,
             N => N_debouncing)
PORT MAP(   clk => clk,           
            rst => rst,             
