...
entity period_counter_micro_tb is
--  Port ( );
end period_counter_micro_tb;

architecture Behavioral of period_counter_micro_tb is
...
SIGNAL prd_sig : STD_LOGIC_VECTOR(19 DOWNTO 0);

begin
UUT : period_counter_micro
