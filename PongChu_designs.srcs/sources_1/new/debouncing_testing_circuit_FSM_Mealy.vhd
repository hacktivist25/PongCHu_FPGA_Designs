...
entity debouncing_testing_circuit_FSM_Mealy is
...
end debouncing_testing_circuit_FSM_Mealy;

architecture Behavioral of debouncing_testing_circuit_FSM_Mealy is
...
dual_edge_detector_debounced : dual_edge_detector_Mealy
PORT MAP(   clk => clk,           
            rst => rst,             
...
dual_edge_detector_bounce : dual_edge_detector_Mealy
PORT MAP(   clk => clk,           
            rst => rst,             
            input_signal => input_signal,
