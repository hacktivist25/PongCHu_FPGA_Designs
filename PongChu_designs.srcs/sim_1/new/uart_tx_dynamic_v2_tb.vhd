...
entity uart_tx_dynamic_v2_tb is
--  Port ( );
end uart_tx_dynamic_v2_tb;

architecture Behavioral of uart_tx_dynamic_v2_tb is
...
begin
    ...
    -- changing registers just to check if it registers well
    tx_start_sig <= '1';
    WAIT FOR 20 ns;
    tx_start_sig <= '0';
    WAIT FOR 200 ns;
