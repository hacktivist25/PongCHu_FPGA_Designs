...
entity period_counter_ms is
    Port ( clk : in STD_LOGIC;
           ...
           prd : out STD_LOGIC_VECTOR(9 DOWNTO 0)); -- 10 bits to count up to 1 000 ms = 1s
end period_counter_ms;

architecture Behavioral of period_counter_ms is
...
SIGNAL counter_reg, counter_next : INTEGER RANGE 0 TO 49999; -- 1ms period
